        ...
        HandleMenuTrigger: function() {
            ...
            switch (settings.MenuTrigger) {
                ...
                case 'click':
                    ...
                    $(".pcoded-item > li > .pcoded-hasmenu-a ").on('click', function() {
                        var el = $(this).closest('.pcoded-hasmenu')
                        if (el.hasClass('pcoded-trigger')) {
                            el.removeClass('pcoded-trigger');
                        } else {
                            el.closest('.pcoded-inner-navbar').find('li.pcoded-trigger').removeClass('pcoded-trigger');
                            el.addClass('pcoded-trigger');
                        }
